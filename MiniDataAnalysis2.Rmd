...
<!--------------------------- Start your work below --------------------------->
These two questions are chosen because they are 1) they have a straight forward objective, 2) they are correlated, as in they serve the theme of measuring the growth of the trees, 3) the dataset's tidyness serve them best.
<!----------------------------------------------------------------------------->
...
The height_range_id is in a character form, and the plot represents it in alphabetical order. Here, I have changed it into factor for in order to have the numbers show up in increasing order.
```{r}
...
**Variable of interest**: diameter, age
